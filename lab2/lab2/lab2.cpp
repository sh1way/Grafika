    ...
    case WM_PAINT:
        {
            ...
            HBITMAP bgBitMap = (HBITMAP)LoadImage(NULL, L"..\\assets\\b2.bmp", IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
            ...
            while (isRunning) {
                ...
                BitBlt(hdc, personX, personY, 225, 225, spriteMemdc, 0, 0, SRCINVERT);
                ...
                personX += speed;
                if (personX < 0) personX = 800 - 225; // Если персонаж вышел за границу экрана, возвращаем его в начало
            }
